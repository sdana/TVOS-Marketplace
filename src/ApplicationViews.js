...
export default class ApplicationViews extends Component {
    ...
    render () {
        if (this.isAuthenticated()){
            return (
                <React.Fragment>
                    <div style={{ width: "100%", height: "120%", backgroundRepeat: "no-repeat", backgroundPosition: "center center", backgroundAttachment: "fixed", backgroundSize: "cover", backgroundImage: `url(${this.state.wallpaper})` }}>
